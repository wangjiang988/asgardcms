...
@section('content-header')
    <h1>
        {{ trans('testimonials::testimonials.title.create testimonial') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('testimonials::testimonials.title.create testimonial') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.testimonials.testimonial.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('testimonials::admin.testimonials.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
